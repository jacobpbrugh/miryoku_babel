...
#+NAME: hold
| BOOT     | U_NA      | U_NA        | U_NA       |         |       | U_NA       | U_NA        | U_NA      | BOOT     |
...
#+NAME: media-r
| RGB_TOG | RGB_MOD  | RGB_HUI  | EP_TOG   | OUT_TOG  |
| MUTE    | VOLD     | VOLU     | F14      | F15      |
| U_NU    | BT_SEL_0 | BT_SEL_1 | BT_SEL_2 | BT_SEL_3 |
| MPRV    | MPLY     | MNXT     | U_NP     | U_NP     |
...
#+NAME: sym-l
| U_NA | AT   | HASH | DLR  | U_NA |
| [    | ]    | LPRN | RPRN | BSLS |
| PERC | CIRC | AMPR | ASTR | U_NA |
| U_NP | U_NP | EXLM | COLN | U_NA |
...
| BOOT     | U_NA      | U_NA        | U_NA       |       |         | U_NA       | U_NA        | U_NA      | BOOT     |
| LGUI     | LALT      | LCTL        | LSFT       |       |         | LSFT       | LCTL        | LALT      | LGUI     |
| U_BUTTON | ALGR      | U_NA        | U_NA       |       |         | U_NA       | U_NA        | ALGR      | U_BUTTON |
...
Source keycode to implementation equivalent (source, QMK, ZMK, KMonad, SVG, KMK, Kanata).
...
| 8           | 8                | N8            | 8             | 8             | N8            | 8             |
| 9           | 9                | N9            | 9             | 9             | N9            | 9             |
| ALGR        | ALGR             | RALT          | ralt          | AltGr         | RALT          | ralt          |
| AMPR        | AMPR             | AMPS          | &             | &             | AMPR          | &             |
| APP         | APP              | K_APP         | comp          | App           | APP           | comp          |
| ASTR        | ASTR             | ASTRK         | *             | *             | ASTR          | *             |
| AT          | AT               | AT            | @             | @             | AT            | @             |
| BSLS        | BSLS             | BSLH          | \\            | \\            | BSLS          | \\            |
| BSPC        | BSPC             | BSPC          | bspc          | Back Space    | BSPC          | bspc          |
...
| BTN1        | BTN1             | U_BTN1        | #(kp/ kp5)    | Left Button   | MB_LMB        | #(kp/ kp5)    |
| BTN2        | BTN2             | U_BTN2        | #(kp- kp5)    | Right Button  | MB_RMB        | #(kp- kp5)    |
| BTN3        | BTN3             | U_BTN3        | #(kp* kp5)    | Middle Button | MB_MMB        | #(kp* kp5)    |
| CAPS        | CAPS             | CAPS          | caps          | Caps Lock     | CAPS          | caps          |
| CIRC        | CIRC             | CARET         | ^             | ^             | CIRC          | ^             |
| COLN        | COLN             | COLON         | :             | :             | COLN          | :             |
| COMM        | COMM             | COMMA         | U_COMM        | S_COMM        | COMM          | U_COMM        |
| CPSWRD      | CW_TOGG          | &u_caps_word  | caps          | Caps Word     | U_CW          | caps          |
| DEL         | DEL              | DEL           | del           | Delete        | DEL           | del           |
| DF(U_BASE)  | TD(U_TD_U_BASE)  | &u_to_U_BASE  | U_DF(U_BASE)  | U_DF(U_BASE)  | U_DF(U_BASE)  | U_DF(U_BASE)  |
| DF(U_EXTRA) | TD(U_TD_U_EXTRA) | &u_to_U_EXTRA | U_DF(U_EXTRA) | U_DF(U_EXTRA) | U_DF(U_EXTRA) | U_DF(U_EXTRA) |
| DF(U_TAP)   | TD(U_TD_U_TAP)   | &u_to_U_TAP   | U_DF(U_TAP)   | U_DF(U_TAP)   | U_DF(U_TAP)   | U_DF(U_TAP)   |
| DLR         | DLR              | DLLR          | $             | $             | DLR           | $             |
| DOT         | DOT              | DOT           | .             | .             | DOT           | .             |
| DOWN        | DOWN             | DOWN          | down          | Down          | DOWN          | down          |
| DQUO        | DQUO             | DQT           | U_DQUO        | \"            | DQUO          | U_DQUO        |
| END         | END              | END           | end           | End           | END           | end           |
| ENT         | ENT              | RET           | ent           | Enter         | ENT           | ret           |
| EP_OFF      |                  |               |               | EP Off        | PS_OFF        |               |
| EP_TOG      |                  | U_EP_TOG      |               | EP Toggle     | PS_TOG        |               |
| EQL         | EQL              | EQUAL         | =             | =             | EQL           | =             |
| ESC         | ESC              | ESC           | esc           | Esc           | ESC           | escape        |
| EXLM        | EXLM             | EXCL          | !             | !             | EXLM          | !             |
...
| INS         | INS              | INS           | ins           | Insert        | INS           | ins           |
| LALT        | LALT             | LALT          | alt           | Alt           | LALT          | lalt          |
| LBRC        | LBRC             | LBKT          | [             | [             | LBRC          | [             |
| LCBR        | LCBR             | LBRC          | {             | {             | LCBR          | {             |
| LCTL        | LCTL             | LCTRL         | ctl           | Ctrl          | LCTL          | lctl          |
| LEFT        | LEFT             | LEFT          | left          | Left          | LEFT          | left          |
| LGUI        | LGUI             | LGUI          | met           | Meta          | LGUI          | lmet          |
| LPRN        | LPRN             | LPAR          | U_LPRN        | S_LPRN        | LPRN          | U_LPRN        |
| LSFT        | LSFT             | LSHFT         | sft           | Shift         | LSFT          | lsft          |
| LT          | LT               | LT            | <             | <             | LABK          | <             |
| MINS        | MINS             | MINUS         | -             | -             | MINS          | -             |
| MNXT        | MNXT             | C_NEXT        | nextsong      | Next          | MNXT          | nextsong      |
| MPLY        | MPLY             | C_PP          | playpause     | Play Pause    | MPLY          | playpause     |
| MPRV        | MPRV             | C_PREV        | previoussong  | Prev          | MPRV          | previoussong  |
| MS_D        | MS_D             | U_MS_D        | kp2           | Mouse Down    | MS_DN         | kp2           |
| MS_L        | MS_L             | U_MS_L        | kp4           | Mouse Left    | MS_LT         | kp4           |
| MS_R        | MS_R             | U_MS_R        | kp6           | Mouse Right   | MS_RT         | kp6           |
| MS_U        | MS_U             | U_MS_U        | kp8           | Mouse Up      | MS_UP         | kp8           |
| MSTP        | MSTP             | C_STOP        | stopcd        | Stop          | MSTP          | stopcd        |
| MUTE        | MUTE             | C_MUTE        | mute          | Mute          | MUTE          | mute          |
| NO          | NO               | &none         | XX            |               | NO            | XX            |
| OUT_TOG     | OU_AUTO          | &u_out_tog    |               | Out Toggle    | HID           |               |
| OUT_BT      | OU_BT            | &out OUT_BT   |               | Out BT        |               |               |
| OUT_USB     | OU_USB           | &out OUT_USB  |               | Out USB       |               |               |
| PAUS        | PAUS             | PAUSE_BREAK   | pause         | Pause Break   | PAUS          | pause         |
| PERC        | PERC             | PRCNT         | %             | %             | PERC          | %             |
| PGDN        | PGDN             | PG_DN         | pgdn          | Page Down     | PGDN          | pgdn          |
| PGUP        | PGUP             | PG_UP         | pgup          | Page Up       | PGUP          | pgup          |
| PIPE        | PIPE             | PIPE          | U_PIPE        | S_PIPE        | PIPE          | U_PIPE        |
| PLUS        | PLUS             | PLUS          | +             | +             | PLUS          | +             |
| PSCR        | PSCR             | PSCRN         | sysrq         | PrtScn SysRq  | PSCR          | sysrq         |
| QUES        | QUES             | QMARK         | ?             | ?             | QUES          | ?             |
| QUOT        | QUOT             | SQT           | U_QUOT        | '             | QUOT          | U_QUOT        |
| RBRC        | RBRC             | RBKT          | ]             | ]             | RBRC          | ]             |
| RCBR        | RCBR             | RBRC          | }             | }             | RCBR          | }             |
...
| RGHT        | RGHT             | RIGHT         | right         | Right         | RGHT          | right         |
| RPRN        | RPRN             | RPAR          | U_RPRN        | S_RPRN        | RPRN          | U_RPRN        |
| SCLN        | SCLN             | SEMI          | ;             | ;             | SCLN          | ;             |
| SLCK        | SCRL             | SLCK          | slck          | Scroll Lock   | SLCK          | slck          |
| SLSH        | SLSH             | SLASH         | /             | /             | SLSH          | /             |
| SPC         | SPC              | SPACE         | spc           | Space         | SPC           | spc           |
| TAB         | TAB              | TAB           | tab           | Tab           | TAB           | tab           |
| TILD        | TILD             | TILDE         | ~             | ~             | TILD          | ~             |
| TRNS        | TRNS             | &trans        | _             | Trans         | TRNS          | _             |
| UNDS        | UNDS             | UNDER         | \_            | _             | UNDS          | \_            |
| UP          | UP               | UP            | up            | Up            | UP            | up            |
| VOLD        | VOLD             | C_VOL_DN      | vold          | Volume Down   | VOLD          | vold          |
| VOLU        | VOLU             | C_VOL_UP      | volu          | Volume Up     | VOLU          | volu          |
...
if target == 'qmk':
  ...
  basic_prefix = 'KC_'
  basic_suffix = ''
  for source, qmk, zmk, kmonad, long, kmk, kanata in keycode_translation_table:
  ...
  basic_suffix = ''
  for source, qmk, zmk, kmonad, long, kmk, kanata in keycode_translation_table:
    keycode_translation_dict[source] = kanata
elif target == 'svg':
...
**** [[tangled/kanata/miryoku_layer_alternatives.h]]

#+BEGIN_SRC C :main no :noweb yes :padline no :mkdirp yes :tangle tangled/kanata/miryoku_layer_alternatives.h
// Copyright 2022 Manna Harbour
// https://github.com/manna-harbour/miryoku
// generated -*- buffer-read-only: t -*-
<<table-layer-init(target="kanata")>>
...
**** [[tangled/kanata/miryoku_layer_selection.h]]

#+BEGIN_SRC C :main no :noweb yes :padline no :mkdirp yes :tangle tangled/kanata/miryoku_layer_selection.h
// Copyright 2022 Manna Harbour
// https://github.com/manna-harbour/miryoku
// generated -*- buffer-read-only: t -*-
...
**** [[tangled/kanata/miryoku_layer_list.h]]

#+BEGIN_SRC C :main no :noweb yes :padline no :mkdirp yes :tangle tangled/kanata/miryoku_layer_list.h
// Copyright 2022 Manna Harbour
// https://github.com/manna-harbour/miryoku
// generated -*- buffer-read-only: t -*-
