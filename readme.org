...
| AMPR        | AMPR             | AMPS          | &             | &             | AMPR          | &             |
| APP         | APP              | K_APP         | comp          | App           | APP           | menu          |
...
| MNXT        | MNXT             | C_NEXT        | nextsong      | Next          | MNXT          | next          |
| MPLY        | MPLY             | C_PP          | playpause     | Play Pause    | MPLY          | pp            |
| MPRV        | MPRV             | C_PREV        | previoussong  | Prev          | MPRV          | prev          |
...
| MSTP        | MSTP             | C_STOP        | stopcd        | Stop          | MSTP          | pp            |
...
| PLUS        | PLUS             | PLUS          | +             | +             | PLUS          | +             |
| PSCR        | PSCR             | PSCRN         | sysrq         | PrtScn SysRq  | PSCR          | ssrq          |
