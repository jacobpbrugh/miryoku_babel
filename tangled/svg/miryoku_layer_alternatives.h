...
"A",               "Z",               "E",               "R",               "T",               "Y",               "U",               "I",               "O",               "P",               \
U_MT("Q", "Meta"), U_MT("S", "Alt"),  U_MT("D", "Ctrl"), U_MT("F", "Shift"),"G",               "H",               U_MT("J", "Shift"),U_MT("K", "Ctrl"), U_MT("L", "Alt"),  U_MT("M", "Meta"), \
U_LT("W", U_BUTTON),U_MT("X", "AltGr"),"C",               "V",               "B",               "N",               U_S("<", "S_COMM"),U_S(">", "."),     U_SMT("?", "/", "AltGr"),U_SLT("\"", "'", U_BUTTON),\
...
U_LT("Z", U_BUTTON),U_MT("X", "AltGr"),"C",               "V",               "B",               "K",               "M",               U_S("<", "S_COMM"),U_SMT(">", ".", "AltGr"),U_SLT("?", "/", U_BUTTON),\
U_NP,              U_NP,              U_LT("Delete", U_FUN),U_LT("Back Space", U_NUM),U_LT("Enter", U_SYM),U_LT("Tab", U_MOUSE),U_LT("Space", U_NAV),U_LT("Esc", U_MEDIA),U_NP,              U_NP
...
"Q",               "W",               "F",               "P",               "B",               "J",               "L",               "U",               "Y",               U_S("\"", "'"),    \
U_MT("A", "Meta"), U_MT("R", "Alt"),  U_MT("S", "Ctrl"), U_MT("T", "Shift"),"G",               "K",               U_MT("N", "Shift"),U_MT("E", "Ctrl"), U_MT("I", "Alt"),  U_MT("O", "Meta"), \
U_LT("Z", U_BUTTON),U_MT("X", "AltGr"),"C",               "D",               "V",               "M",               "H",               U_S("<", "S_COMM"),U_SMT(">", ".", "AltGr"),U_SLT("?", "/", U_BUTTON),\
U_NP,              U_NP,              U_LT("Delete", U_FUN),U_LT("Back Space", U_NUM),U_LT("Enter", U_SYM),U_LT("Tab", U_MOUSE),U_LT("Space", U_NAV),U_LT("Esc", U_MEDIA),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_DVORAK_FLIP \
U_S("\"", "'"),    U_S("<", "S_COMM"),U_S(">", "."),     "P",               "Y",               "F",               "G",               "C",               "R",               "L",               \
U_MT("A", "Meta"), U_MT("O", "Alt"),  U_MT("E", "Ctrl"), U_MT("U", "Shift"),"I",               "D",               U_MT("H", "Shift"),U_MT("T", "Ctrl"), U_MT("N", "Alt"),  U_MT("S", "Meta"), \
U_SLT("?", "/", U_BUTTON),U_MT("Q", "AltGr"),"J",               "K",               "X",               "B",               "M",               "W",               U_MT("V", "AltGr"),U_LT("Z", U_BUTTON),\
U_NP,              U_NP,              U_LT("Delete", U_FUN),U_LT("Back Space", U_NUM),U_LT("Enter", U_SYM),U_LT("Tab", U_MOUSE),U_LT("Space", U_NAV),U_LT("Esc", U_MEDIA),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_HALMAK_FLIP \
"W",               "L",               "R",               "B",               "Z",               U_S("\"", "'"),    "Q",               "U",               "D",               "J",               \
U_MT("S", "Meta"), U_MT("H", "Alt"),  U_MT("N", "Ctrl"), U_MT("T", "Shift"),U_S("<", "S_COMM"),U_S(">", "."),     U_MT("A", "Shift"),U_MT("E", "Ctrl"), U_MT("O", "Alt"),  U_MT("I", "Meta"), \
U_LT("F", U_BUTTON),U_MT("M", "AltGr"),"V",               "C",               U_S("?", "/"),     "G",               "P",               "X",               U_MT("K", "AltGr"),U_LT("Y", U_BUTTON),\
U_NP,              U_NP,              U_LT("Delete", U_FUN),U_LT("Back Space", U_NUM),U_LT("Enter", U_SYM),U_LT("Tab", U_MOUSE),U_LT("Space", U_NAV),U_LT("Esc", U_MEDIA),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_WORKMAN_FLIP \
"Q",               "D",               "R",               "W",               "B",               "J",               "F",               "U",               "P",               U_S("\"", "'"),    \
U_MT("A", "Meta"), U_MT("S", "Alt"),  U_MT("H", "Ctrl"), U_MT("T", "Shift"),"G",               "Y",               U_MT("N", "Shift"),U_MT("E", "Ctrl"), U_MT("O", "Alt"),  U_MT("I", "Meta"), \
U_LT("Z", U_BUTTON),U_MT("X", "AltGr"),"M",               "C",               "V",               "K",               "L",               U_S("<", "S_COMM"),U_SMT(">", ".", "AltGr"),U_SLT("?", "/", U_BUTTON),\
U_NP,              U_NP,              U_LT("Delete", U_FUN),U_LT("Back Space", U_NUM),U_LT("Enter", U_SYM),U_LT("Tab", U_MOUSE),U_LT("Space", U_NAV),U_LT("Esc", U_MEDIA),U_NP,              U_NP
...
"Q",               "W",               "E",               "R",               "T",               "Z",               "U",               "I",               "O",               "P",               \
U_MT("A", "Meta"), U_MT("S", "Alt"),  U_MT("D", "Ctrl"), U_MT("F", "Shift"),"G",               "H",               U_MT("J", "Shift"),U_MT("K", "Ctrl"), U_MT("L", "Alt"),  U_SMT("\"", "'", "Meta"),\
U_LT("Y", U_BUTTON),U_MT("X", "AltGr"),"C",               "V",               "B",               "N",               "M",               U_S("<", "S_COMM"),U_SMT(">", ".", "AltGr"),U_SLT("?", "/", U_BUTTON),\
U_NP,              U_NP,              U_LT("Delete", U_FUN),U_LT("Back Space", U_NUM),U_LT("Enter", U_SYM),U_LT("Tab", U_MOUSE),U_LT("Space", U_NAV),U_LT("Esc", U_MEDIA),U_NP,              U_NP
...
"Page Up",         "Home",            "Up",              "End",             "Insert",          U_NA,              U_NA,              U_NA,              U_NA,              U_BOOT,            \
"Page Down",       "Left",            "Down",            "Right",           "Caps Lock",       U_NA,              "Shift",           "Ctrl",            "Alt",             "Meta",            \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              U_NA,              U_NA,              "AltGr",           U_NA,              \
U_NP,              U_NP,              "Delete",          "Back Space",      "Enter",           U_NA,              U_HELD(U_NA),      U_NA,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV_FLIP \
"Home",            "Page Down",       "Page Up",         "End",             "Insert",          U_NA,              U_NA,              U_NA,              U_NA,              U_BOOT,            \
"Left",            "Down",            "Up",              "Right",           "Caps Lock",       U_NA,              "Shift",           "Ctrl",            "Alt",             "Meta",            \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              U_NA,              U_NA,              "AltGr",           U_NA,              \
U_NP,              U_NP,              "Delete",          "Back Space",      "Enter",           U_NA,              U_HELD(U_NA),      U_NA,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV_INVERTEDT \
U_BOOT,            U_NA,              U_NA,              U_NA,              U_NA,              "Insert",          "Home",            "Up",              "End",             "Page Up",         \
"Meta",            "Alt",             "Ctrl",            "Shift",           U_NA,              "Caps Lock",       "Left",            "Down",            "Right",           "Page Down",       \
U_NA,              "AltGr",           U_NA,              U_NA,              U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
...
"Meta",            "Alt",             "Ctrl",            "Shift",           U_NA,              "Left",            "Down",            "Up",              "Right",           "Caps Lock",       \
U_NA,              "AltGr",           U_NA,              U_NA,              U_NA,              "Home",            "Page Down",       "Page Up",         "End",             "Insert",          \
U_NP,              U_NP,              U_NA,              U_HELD(U_NA),      U_NA,              "Enter",           "Back Space",      "Delete",          U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV \
U_BOOT,            U_NA,              U_NA,              U_NA,              U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
"Meta",            "Alt",             "Ctrl",            "Shift",           U_NA,              "Caps Lock",       "Left",            "Down",            "Up",              "Right",           \
U_NA,              "AltGr",           U_NA,              U_NA,              U_NA,              "Insert",          "Home",            "Page Down",       "Page Up",         "End",             \
U_NP,              U_NP,              U_NA,              U_HELD(U_NA),      U_NA,              "Enter",           "Back Space",      "Delete",          U_NP,              U_NP


#define MIRYOKU_ALTERNATIVES_MOUSE_INVERTEDT_FLIP \
"Scroll Up",       "Scroll Left",     "Mouse Up",        "Scroll Right",    U_NU,              U_NA,              U_NA,              U_NA,              U_NA,              U_BOOT,            \
...
"Scroll Left",     "Scroll Down",     "Scroll Up",       "Scroll Right",    U_NU,              U_NA,              U_NA,              U_NA,              U_NA,              U_BOOT,            \
"Mouse Left",      "Mouse Down",      "Mouse Up",        "Mouse Right",     U_NU,              U_NA,              "Shift",           "Ctrl",            "Alt",             "Meta",            \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              U_NA,              U_NA,              "AltGr",           U_NA,              \
U_NP,              U_NP,              "Middle Button",   "Left Button",     "Right Button",    U_HELD(U_NA),      U_NA,              U_NA,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MOUSE_INVERTEDT \
U_BOOT,            U_NA,              U_NA,              U_NA,              U_NA,              U_NU,              "Scroll Left",     "Mouse Up",        "Scroll Right",    "Scroll Up",       \
...
U_NA,              "AltGr",           U_NA,              U_NA,              U_NA,              "Scroll Left",     "Scroll Down",     "Scroll Up",       "Scroll Right",    U_NU,              \
U_NP,              U_NP,              U_NA,              U_NA,              U_HELD(U_NA),      "Right Button",    "Left Button",     "Middle Button",   U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MOUSE \
U_BOOT,            U_NA,              U_NA,              U_NA,              U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
"Meta",            "Alt",             "Ctrl",            "Shift",           U_NA,              U_NU,              "Mouse Left",      "Mouse Down",      "Mouse Up",        "Mouse Right",     \
U_NA,              "AltGr",           U_NA,              U_NA,              U_NA,              U_NU,              "Scroll Left",     "Scroll Down",     "Scroll Up",       "Scroll Right",    \
U_NP,              U_NP,              U_NA,              U_NA,              U_HELD(U_NA),      "Right Button",    "Left Button",     "Middle Button",   U_NP,              U_NP


#define MIRYOKU_ALTERNATIVES_MEDIA_INVERTEDT_FLIP \
U_S("Hue  -", "RGB Hue  +"),U_S("Sat  -", "RGB Sat  +"),"Volume Up",       U_S("Value  -", "RGB Value  +"),U_S("Off", "RGB Toggle"),U_NA,              U_NA,              U_NA,              U_NA,              U_BOOT,            \
U_S("Mode  -", "RGB Mode  +"),"Prev",            "Volume Down",     "Next",            U_S("Off", "EP Toggle"),U_NA,              "Shift",           "Ctrl",            "Alt",             "Meta",            \
U_S("Clear", "BT  0 Select"),U_S("Clear", "BT  1 Select"),U_S("Clear", "BT  2 Select"),U_S("Clear", "BT  3 Select"),U_S("USB", "Out Toggle"),U_NA,              U_NA,              U_NA,              "AltGr",           U_NA,              \
U_NP,              U_NP,              "Mute",            "Play Pause",      "Stop",            U_NA,              U_NA,              U_HELD(U_NA),      U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MEDIA_FLIP \
U_S("Mode  -", "RGB Mode  +"),U_S("Hue  -", "RGB Hue  +"),U_S("Sat  -", "RGB Sat  +"),U_S("Value  -", "RGB Value  +"),U_S("Off", "RGB Toggle"),U_NA,              U_NA,              U_NA,              U_NA,              U_BOOT,            \
"Prev",            "Volume Down",     "Volume Up",       "Next",            U_S("Off", "EP Toggle"),U_NA,              "Shift",           "Ctrl",            "Alt",             "Meta",            \
U_S("Clear", "BT  0 Select"),U_S("Clear", "BT  1 Select"),U_S("Clear", "BT  2 Select"),U_S("Clear", "BT  3 Select"),U_S("USB", "Out Toggle"),U_NA,              U_NA,              U_NA,              "AltGr",           U_NA,              \
U_NP,              U_NP,              "Mute",            "Play Pause",      "Stop",            U_NA,              U_NA,              U_HELD(U_NA),      U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MEDIA_INVERTEDT \
U_BOOT,            U_NA,              U_NA,              U_NA,              U_NA,              U_S("Off", "RGB Toggle"),U_S("Mode  -", "RGB Mode  +"),"Volume Up",       U_S("Hue  -", "RGB Hue  +"),U_S("Sat  -", "RGB Sat  +"),\
"Meta",            "Alt",             "Ctrl",            "Shift",           U_NA,              U_S("Off", "EP Toggle"),"Prev",            "Volume Down",     "Next",            U_S("Value  -", "RGB Value  +"),\
U_NA,              "AltGr",           U_NA,              U_NA,              U_NA,              U_S("USB", "Out Toggle"),U_S("Clear", "BT  0 Select"),U_S("Clear", "BT  1 Select"),U_S("Clear", "BT  2 Select"),U_S("Clear", "BT  3 Select"),\
U_NP,              U_NP,              U_HELD(U_NA),      U_NA,              U_NA,              "Stop",            "Play Pause",      "Mute",            U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MEDIA_VI \
U_BOOT,            U_NA,              U_NA,              U_NA,              U_NA,              U_S("Mode  -", "RGB Mode  +"),U_S("Hue  -", "RGB Hue  +"),U_S("Sat  -", "RGB Sat  +"),U_S("Value  -", "RGB Value  +"),U_S("Off", "RGB Toggle"),\
"Meta",            "Alt",             "Ctrl",            "Shift",           U_NA,              "Prev",            "Volume Down",     "Volume Up",       "Next",            U_S("Off", "EP Toggle"),\
U_NA,              "AltGr",           U_NA,              U_NA,              U_NA,              U_S("Clear", "BT  0 Select"),U_S("Clear", "BT  1 Select"),U_S("Clear", "BT  2 Select"),U_S("Clear", "BT  3 Select"),U_S("USB", "Out Toggle"),\
U_NP,              U_NP,              U_HELD(U_NA),      U_NA,              U_NA,              "Stop",            "Play Pause",      "Mute",            U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MEDIA \
U_BOOT,            U_NA,              U_NA,              U_NA,              U_NA,              U_S("Off", "RGB Toggle"),U_S("Mode  -", "RGB Mode  +"),U_S("Hue  -", "RGB Hue  +"),U_S("Off", "EP Toggle"),U_S("USB", "Out Toggle"),\
"Meta",            "Alt",             "Ctrl",            "Shift",           U_NA,              "Mute",            "Volume Down",     "Volume Up",       "F14",             "F15",             \
U_NA,              "AltGr",           U_NA,              U_NA,              U_NA,              U_NU,              U_S("Clear", "BT  0 Select"),U_S("Clear", "BT  1 Select"),U_S("Clear", "BT  2 Select"),U_S("Clear", "BT  3 Select"),\
U_NP,              U_NP,              U_HELD(U_NA),      U_NA,              U_NA,              "Prev",            "Play Pause",      "Next",            U_NP,              U_NP


#define MIRYOKU_ALTERNATIVES_NUM_FLIP \
U_BOOT,            U_NA,              U_NA,              U_NA,              U_NA,              U_S("{", "["),     U_S("&", "7"),     U_S("*", "8"),     U_S("S_LPRN", "9"),U_S("}", "]"),     \
"Meta",            "Alt",             "Ctrl",            "Shift",           U_NA,              U_S("+", "="),     U_S("$", "4"),     U_S("%", "5"),     U_S("^", "6"),     U_S(":", ";"),     \
U_NA,              "AltGr",           U_NA,              U_NA,              U_NA,              U_S("S_PIPE", "\\"),U_S("!", "1"),     U_S("@", "2"),     U_S("#", "3"),     U_S("~", "`"),     \
U_NP,              U_NP,              U_NA,              U_HELD(U_NA),      U_NA,              U_S("_", "-"),     U_S("S_RPRN", "0"),U_S(">", "."),     U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NUM \
U_NP,              U_S("&", "7"),     U_S("*", "8"),     U_S("S_LPRN", "9"),U_NP,              U_NA,              U_NA,              U_NA,              U_NA,              U_BOOT,            \
U_S(":", ";"),     U_S("!", "1"),     U_S("@", "2"),     U_S("#", "3"),     U_S("+", "="),     U_NA,              "Shift",           "Ctrl",            "Alt",             "Meta",            \
U_NP,              U_S("$", "4"),     U_S("%", "5"),     U_S("^", "6"),     U_NP,              U_NA,              U_NA,              U_NA,              "AltGr",           U_NA,              \
U_NP,              U_NP,              U_S("~", "`"),     U_S("S_RPRN", "0"),U_S("_", "-"),     U_NA,              U_HELD(U_NA),      U_NA,              U_NP,              U_NP


#define MIRYOKU_ALTERNATIVES_SYM_FLIP \
U_BOOT,            U_NA,              U_NA,              U_NA,              U_NA,              "{",               "&",               "*",               "S_LPRN",          "}",               \
"Meta",            "Alt",             "Ctrl",            "Shift",           U_NA,              "+",               "$",               "%",               "^",               ":",               \
U_NA,              "AltGr",           U_NA,              U_NA,              U_NA,              "S_PIPE",          "!",               "@",               "#",               "~",               \
U_NP,              U_NP,              U_NA,              U_NA,              U_HELD(U_NA),      "_",               "S_LPRN",          "S_RPRN",          U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_SYM \
U_NP,              "@",               "#",               "$",               U_NP,              U_NA,              U_NA,              U_NA,              U_NA,              U_BOOT,            \
U_S("{", "["),     U_S("}", "]"),     "S_LPRN",          "S_RPRN",          U_S("S_PIPE", "\\"),U_NA,              "Shift",           "Ctrl",            "Alt",             "Meta",            \
"%",               "^",               "&",               "*",               U_NP,              U_NA,              U_NA,              U_NA,              "AltGr",           U_NA,              \
U_NP,              U_NP,              "!",               ":",               U_NP,              U_HELD(U_NA),      U_NA,              U_NA,              U_NP,              U_NP


#define MIRYOKU_ALTERNATIVES_FUN_FLIP \
U_BOOT,            U_NA,              U_NA,              U_NA,              U_NA,              "PrtScn SysRq",    "F7",              "F8",              "F9",              "F12",             \
"Meta",            "Alt",             "Ctrl",            "Shift",           U_NA,              "Scroll Lock",     "F4",              "F5",              "F6",              "F11",             \
U_NA,              "AltGr",           U_NA,              U_NA,              U_NA,              "Pause Break",     "F1",              "F2",              "F3",              "F10",             \
U_NP,              U_NP,              U_HELD(U_NA),      U_NA,              U_NA,              "Tab",             "Space",           "App",             U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_FUN \
"App",             "F7",              "F8",              "F9",              "PrtScn SysRq",    U_NA,              U_NA,              U_NA,              U_NA,              U_BOOT,            \
"F11",             "F1",              "F2",              "F3",              "Scroll Lock",     U_NA,              "Shift",           "Ctrl",            "Alt",             "Meta",            \
"F10",             "F4",              "F5",              "F6",              "Pause Break",     U_NA,              U_NA,              U_NA,              "AltGr",           U_NA,              \
